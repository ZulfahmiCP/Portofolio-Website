const projectsData = [
  ...
  {
    id: 2,
    title: "Bootcamp Completion Prediction using K-Means",
    problem:
      "High dropout rates in data science bootcamps require a predictive model.",
    solution:
      "Used K-Means clustering on participant data to create graduation status labels.",
    impact:
